function [data,optsPhys,optsNum,optsPlot] = DDFT_DiffusionInfInterval(optsPhys,optsNum,optsPlot)

    if(nargin == 0)
        [optsNum,optsPhys,optsPlot] = Default_DDFT_DiffusionInfInterval();
    end
