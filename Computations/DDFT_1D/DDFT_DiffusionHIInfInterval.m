function [data,optsPhys,optsNum,optsPlot] = DDFT_DiffusionHIInfInterval(optsPhys,optsNum,optsPlot)

    if(nargin == 0)
        [optsNum,optsPhys,optsPlot] = Default_DDFT_DiffusionHIInfInterval();
    end
