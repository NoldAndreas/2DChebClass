function [VBack_S,VAdd_S]=Vext_Cart_Capillary_20_02(y1,y2,t,optsPhys)
...
% ddft: inputs are (r,theta,t,optsPhys)
    ...
    a1     = AttractiveSlit(yw_right-y1,y2,yw_bottom,yw_top,epsilon_w(1));
    a2     = AttractiveWall(yw_top-y2,epsilon_w(2),1);
    a3     = AttractiveSlit(y1-yw_left,y2,yw_bottom,yw_top,epsilon_w(3));    
