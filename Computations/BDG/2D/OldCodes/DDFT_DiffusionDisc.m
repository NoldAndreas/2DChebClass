function [data,optsPhys,optsNum,optsPlot] = DDFT_DiffusionDisc(optsPhys,optsNum,optsPlot)
%************************************************************************* 
...
% !! ONLY WORKING FOR MEAN FIELD -- NEED TO IMPLEMENT BOX_FMT
    ...
    if(nargin == 0)
        %[data,optsPhys,optsNum,optsPlot] = Test_DDFT_DiffusionDisc_FMT();
        [data,optsPhys,optsNum,optsPlot] = Test_DDFT_DiffusionDisc_MF();
        return;
    end
...
%     end
    ...
    function dxdt = dx_dt(t,x)
        ...
        dxdt(Ind.bound,:) = Ind.normalOutR*flux_dir;   
