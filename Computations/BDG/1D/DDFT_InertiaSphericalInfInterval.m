function [data,optsPhys,optsNum,optsPlot] = DDFT_InertiaSphericalInfInterval(optsPhys,optsNum,optsPlot)

    if(nargin == 0)
        [optsNum,optsPhys,optsPlot] = Default_DDFT_InertiaHISphericalInfInterval();
    end
