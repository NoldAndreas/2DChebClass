function [optsNum,optsPhys,optsPlot,name] = TestFMT_DDFT_DiffusionHalfSpace_NSpecies_01_07_13_V1()

    %This is equivalent to:

    %Numerical Parameters    
    Phys_Area = struct('N',[40,40],'L1',2,'L2',2,'y2wall',0.,'N2bound',10,'h',1);
