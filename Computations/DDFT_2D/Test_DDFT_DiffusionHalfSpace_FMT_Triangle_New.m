...
%     HI_Num    = struct('N',[20;20],'L',2,'HI11','noHI_2D','HI12','Oseen_2D_noConv', ...
%                       'HIPreprocess', 'RotnePragerPreprocess2D',...
%                       'HIWallFull',true,'doConv',false);

%     HI_Num    = struct('N',[20;20],'L',2,'HI11','noHI_2D','HI12','TwoOseen_2D_noConv', ...
%                       'HIPreprocess', 'RotnePragerPreprocess2D',...
%                       'HIWallFull',true,'doConv',false);

    HI_Num    = struct('N',[20;20],'L',2,'HI11','noHI_2D','HI12','FullWallHI_2D_noConv', ...
                      'HIPreprocess', 'RotnePragerPreprocess2D',...
                      'HIWallFull',true,'doConv',false);
