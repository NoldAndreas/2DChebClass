...
Phys_Area = struct('shape','InfSpace','y1Min',-inf,'y1Max',inf,'N',[30,30],'L1',4,...
                   'y2Min',-inf,'y2Max',inf,'L2',4);
...
Fex_Num1   = struct('Fex','Meanfield','N',[20;20],'L',2);                
...
DDFTParamsNames = {{'PhysArea','SubArea','PlotArea','V2Num','eqNum','doPlots'}, ...
                   {'PhysArea','SubArea','PlotArea','V2Num','eqNum','doPlots'}, ...
                   {'PhysArea','SubArea','PlotArea','V2Num','eqNum','doPlots'}};

HIParamsNamesDDFT={};               
               
%DDFTName={'Rosenfeld','Roth','Rosenfeld3D'};
DDFTName={'Gaussian','Roth','Rosenfeld3D'};
...
doDDFT={true,false,false};
%doDDFT={false,true,false};

% do we load and save the DDFT data
loadDDFT={false,false,false};
