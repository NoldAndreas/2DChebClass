...
%eqNum    = {eq_Num,eq_Num}; % only implemented for 1 species
...
paramNames = {'PhysArea','PlotArea','FexNum','V2Num','HINum','doPlots'};

DDFTParamsNames = {paramNames, paramNames};
