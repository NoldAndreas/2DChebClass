function output = DDFT_DiffusionInfSpace_HI_NSpecies(optsPhys,optsNum,optsPlot)
%************************************************************************* 
...
%*************************************************************************   
    if(nargin == 0)
        [optsNum,optsPhys,optsPlot] = TestFMT_DDFT_DiffusionInfSpace_HI_NSpecies(true);
    end
    ...
    paramsHI.optsPhys.kBT = kBT;
    paramsHI.optsPhys.nSpecies = nSpecies;
    paramsHI.optsNum.HINum  = optsNum.HINum;
    paramsHI.Pts     = IDC.Pts;  
    IntMatrHI     = DataStorage(['InfSpace' filesep 'HIData'],@HIMatrices2D,paramsHI,IDC);   
    fprintf(1,'done.\n');
    tHI = toc;
    disp(tHI);        
