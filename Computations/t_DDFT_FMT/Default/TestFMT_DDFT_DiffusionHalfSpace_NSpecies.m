function [optsNum,optsPhys,optsPlot,name] = TestFMT_DDFT_DiffusionHalfSpace_NSpecies()

    %This is equivalent to:

    %Numerical Parameters    
    Phys_Area = struct('N',[3;30],'L1',2,'L2',2,'y2wall',0.,'N2bound',10,'h',1);
...
%               'Polar_SpectralFourier_FMT_3D'};                                  
    ...
    V1       = struct('V1DV1','Vext_Cart_6','V0',0.3,'Axis','y2');              
