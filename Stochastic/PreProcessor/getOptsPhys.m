...
optsPhysGlobal=struct('nParticles',optsStruct.nParticles, ...
                ...
                'potParamsNames',{optsStruct.potParamsNames}, ...
                'potParams2Names',{optsStruct.potParams2Names}, ...
...
if(optsStruct.anyDDFT)
    ...
    optsPhysDDFTGlobal=struct('m',optsStruct.mS, ... 
                                    'D0',optsStruct.D0S, ...
                                    'gamma',optsStruct.gammaS,...
                                    'dim',optsStruct.DDFTDim, ...
                                    'type','DDFT');  
