...
Nin  = topIn && centralX;
Nout = topOut && (centralX || ~containsNW || ~containsNE );

Sin  = bottomIn && centralX;
Sout = bottomOut && (centralX || ~containsSW|| ~containsSE);

Ein  = rightIn && centralY;
Eout = rightOut && (centralY || ~containsNE || ~containsSE );

Win  = leftIn && centralY;
Wout = leftOut && (centralY || ~containsNW || ~containsSW );
