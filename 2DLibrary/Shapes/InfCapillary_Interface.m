classdef InfCapillary_Interface < M1SpectralSpectral
    ...
    methods (Access = public)
        ...
        function [y1_kv,y2_kv,J,dH1,dH2] = PhysSpace(this,x1,x2)
            ...
            [y2_kv,dy2dx2,ddy2ddx2] =  LinearMap(x2,this.y2Min,this.y2Max);
            [h2,dh2,ddh2]  =  this.h(y2_kv);
            [y1_kv,Diffy1] =  M1SqrtMap(x1,c2,inf);% M1Tref(x1,0,0.07);                         
            y1_kv          =  y1_kv + h2;
