 classdef HalfSpaceSkewed_Composed < ConvolutionFiniteSupport
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   methods
       function this = HalfSpaceSkewed_Composed(Geometry)
           %Geometry includes:
       ...
       function doPlots(this,V)                      
           ...
           this.Sub_Strip.doPlots(V(this.mark_id(:,1)),'SC'); hold on;           
           
           PlotArea.y2Min = this.Sub_HalfSpace.y2Min;
           PlotArea.y2Max = yl(2);
           
           this.Sub_HalfSpace.InterpolationPlot(PlotArea,true);
           this.Sub_HalfSpace.doPlots(V(this.mark_id(:,2)),'SC');
