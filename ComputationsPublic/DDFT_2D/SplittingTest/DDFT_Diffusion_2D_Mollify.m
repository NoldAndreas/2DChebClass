function [data,optsPhys,optsNum,optsPlot] = DDFT_Diffusion_2D_Mollify(optsPhys,optsNum,optsPlot)
%************************************************
...
%************************************************
    ...
    if(doHI)        
        ...
        IntMatrHI     = DataStorage(['HIData' filesep class(IDC)],@HIMatrices2D_Mollify,paramsHI,IDC);      
        fprintf(1,'done.\n');
        t_HI = toc;
